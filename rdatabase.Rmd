...
odbc_driver_list <- odbc::odbcListDrivers()
odbc_driver <- grep("PostgreSQL", odbc_driver_list[which(odbc_driver_list["attribute"]=="Driver"), "name"], value = TRUE)[1]
```

```{sh, eval = FALSE, echo = FALSE, results = "hide"}
sudo apt-get update && sudo apt-get install postgresql-11 postgresql-client-11
# ps -ef | grep postgre
